...
app.post("/api/users", async (req, res) => {
  ...
  // Jag tänker att check av username och password borde komma direkt här uppe eller?
  ...
  // Okej jag flyttade upp funktionen hit, det blir mer logiskt för mig att förstå om det funkar?
  try {
